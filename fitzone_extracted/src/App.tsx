...
function WhatsAppButton() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-6 right-[4.5rem] z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
      ...
      <span className="absolute right-full mr-4 bg-black/80 text-white text-sm font-bold px-3 py-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap backdrop-blur-sm pointer-events-none">
        Chat with us
      </span>
    </a>
  );
